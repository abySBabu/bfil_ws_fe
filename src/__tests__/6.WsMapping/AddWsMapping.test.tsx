...
test.describe('Watershed mapping automation', () => {
    ...
    //Test Number : 1
    test('Should check add icon visible in watershed mapping', async () => {
    ...
    test('Should check add icon clickable in watershed mapping', async () => {
        test.setTimeout(800000);
        const browser = await chromium.launch({
            headless: false,
            channel: 'chrome',
    ...
    test('Should add Watershed Mapping add visible', async () => {
        test.setTimeout(800000);
        const browser = await chromium.launch({
            headless: false,
            channel: 'chrome',
