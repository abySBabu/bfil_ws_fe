...
const OtherActivitiesReport: React.FC = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            setReportData(reportData1.activitiesWithoutWatershedIdList);
            //console.log("Report data:", reportData);
            const uniqueWatershedNames = new Set<string>();
            reportData1.activitiesWithoutWatershedIdList.forEach((activity: Activity) => {
    ...
    return (
        <div>
            <Typography variant="h5" align='center' sx={{ mb: 2 }}>
                Non Watershed Report {selectedYear}
            </Typography>
                        ...
                        <Table sx={{ maxWidth: '100%' }}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell sx={{ lineHeight: '1', maxWidth: '200px', border: '1px solid #ccc' }} align="center" rowSpan={2}>Process Type</TableCell>
                                    <TableCell sx={{ lineHeight: '1', maxWidth: '200px', border: '1px solid #ccc' }} align="center" rowSpan={2}>Plan</TableCell>
                                    <TableCell sx={{ lineHeight: '1', maxWidth: '200px', border: '1px solid #ccc' }} align="center" rowSpan={2}>Progress</TableCell>
                            ...
                            <TableBody>
                                {watershedNames.length === 0 ? (
                                    <TableRow>
                                        <TableCell colSpan={7 + watershedNames.length * 4 + 1} sx={{ textAlign: 'center', fontWeight: 'bold' }}>
                                            No records
                                        </TableCell>
                                    </TableRow>
                                ) : (
...
export default OtherActivitiesReport;
