...
import { Box, Card, CardContent, CardMedia, Typography, Grid, Dialog } from '@mui/material';
...
export const Dashboard: React.FC = () => {
    ...
    return (<>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', gap: '12px' }}>
                {keys.map((k, i) => (
                    <Card onClick={() => setgMod(!gMod)} sx={{
                        ...
                        <CardContent>
                            <Typography sx={{ mb: 1 }}>{k}</Typography>
                            <Typography variant='h5'><b>{data[i]}</b></Typography>
                        </CardContent>
        ...
        <Dialog open={gMod} onClose={() => setgMod(false)}>
            <LineChart
