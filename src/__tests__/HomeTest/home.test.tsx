...
//     //Failure test case 
//     test('Should check test role have view restricted screen', async () => {
//         test.setTimeout(800000);
//         const browser = await chromium.launch({
//             headless: false,
//             channel: 'chrome',
...
//     test('Should check test role have view restricted screen with add , edit', async () => {
//         test.setTimeout(800000);
//         const browser = await chromium.launch({
//             headless: false,
//             channel: 'chrome',
...
//     test.only('Should check the company admin role screen permission', async () => {
//         test.setTimeout(800000);
//         const browser = await chromium.launch({
//             headless: false,
//             channel: 'chrome',
