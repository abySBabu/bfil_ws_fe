...
<Box sx={{display: 'flex',flexDirection: { xs: 'column', sm: 'row' },alignItems: 'center',gap: { xs: 1, sm: 2 },}} >
    <TextField label={t("p_User_Management.ss_Search_Label")} fullWidth={false} value={searchQuery}  onChange={(e) => setSearchQuery(e.target.value)}
      variant="outlined" size="small" InputProps={{ startAdornment: (<InputAdornment position="start">
        ...
        startIcon={<PersonAddIcon />} sx={{height: { xs: 'auto', sm: '45px' }, width: { xs: '80%', sm: '150px' },ml: { xs: 0, sm: '4px' },
